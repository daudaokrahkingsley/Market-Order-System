...
<html lang="en">
  ...
  <body>
    <center>
      <h1 style="color: white;">FILL THIS FORM TO ORDER YOUR PIZZA</h1>
      ...
      <form action="insert.php" method="post" onsubmit=" return verifySpace()">
        <p>
         ...
         <p>
            ...
            <input type="text" name="item" id="Email"  maxlength="10" required style="margin-left: 113px" value="PIZZA" readonly/>
          </p>
